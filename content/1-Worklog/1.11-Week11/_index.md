...
| 30/06/2026 | Tuesday | Finalize the deployment docs and setup guide for the Money Manager system.<br>Configure Amazon CloudWatch: Logs, Metrics, Alarms for ALB, EC2, Aurora, Lambda, SQS.<br>Prepare rollback scripts and verify High Availability across 2 Availability Zones. | [Final Project](https://github.com/vinhpham2808/J2EE) |
...
| 02/07/2026 | Thursday | Final feature check and full code review across the Spring Boot backend and React frontend.<br>Write the detailed report: VPC multi-AZ architecture, ALB → EC2 → Aurora/ElastiCache/DynamoDB flows.<br>Create the final repository and push the latest code. | [Final Project](https://github.com/vinhpham2808/J2EE) |
| 03/07/2026 | Friday | Verify the async flow: SQS → EC2 Worker → Lambda (Report/Invoice) → S3.<br>Test the notification flow: Amazon SNS email alerts for budget exceeded and subscription expiry.<br>Back up Aurora MySQL data, snapshot the environment and share the repository link with the instructor. | [Final Project](https://github.com/vinhpham2808/J2EE) |
...
- AWS services: CloudWatch, SNS, SQS, Lambda, S3, Aurora MySQL backup/snapshot
